...
#>  [1] 8.597474 1.678268 4.419629 6.115375 3.639455 6.145547 2.417961 5.162764
#>  [9] 3.917949 2.039929
rW(10,alpha=1,beta=2)
#>  [1] 1.458332 1.549206 1.805301 2.919549 3.180939 2.008597 1.954462 1.176882
#>  [9] 2.410376 2.659238
rL(10,alpha=1,beta=.1)
#>  [1] 1.1568234 0.9723663 0.9305580 0.9932883 1.0127382 1.0554698 0.9293851
#>  [8] 1.5640994 1.2884745 1.0128523
```
...
r.tc_index(x=x,y=y,z=z,
           ...
           method=c("MLE"))
#>          c₁       c₂      TPF₁      TPF₂      TPF₃
#> J  1.789605 5.906679 0.9467974 0.5346826 0.9299966
#> ED 1.437977 6.687991 0.8484037 0.6485501 0.8484289
#> MV 1.621761 6.279085 0.9097207 0.5906839 0.8971593
#> NI 1.641979 6.242775 0.9150538 0.5846827 0.9008124
#> M  1.508386 6.521586 0.8747711 0.6262105 0.8700057
```
