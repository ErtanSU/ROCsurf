...
#>  [1] 2.242858 6.091214 5.391097 6.881051 5.354709 3.197900 5.609706 2.451796
#>  [9] 3.545512 2.827173
rW(10,alpha=1,beta=2)
#>  [1] 2.8192016 0.3244801 2.1849837 1.0895487 0.9352035 7.1253605 4.2469907
#>  [8] 0.2607605 1.3447804 5.4101940
rL(10,alpha=1,beta=.1)
#>  [1] 0.8444446 1.0462391 1.0612814 1.3296183 1.2873368 1.0451574 0.9306101
#>  [8] 0.9560757 1.2599472 1.3165424
```
...
r.tc_index(x=x,y=y,z=z,
           ...
           method=c("MLE"))
#>          c₁       c₂      TPF₁      TPF₂      TPF₃
#> J  1.625675 5.993619 0.9525857 0.6258076 0.9279917
#> ED 1.346212 6.621478 0.8778737 0.7174197 0.8632860
#> MV 1.519486 6.252888 0.9306786 0.6636832 0.9051674
#> NI 1.531197 6.234361 0.9334412 0.6603425 0.9069685
#> M  1.394354 6.517566 0.8949560 0.7028695 0.8763098
```
